Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
The ABFRealmMapView class creates a controller object that inherits MKMapView and manages fetching and displaying annotations for a Realm object class that contains coordinate data. 
                   DESC
